            ...
            <table class="table compare-table">
              ...
              <tbody>
                <tr class="product-shop-row first odd">
                  <th>&nbsp;</th>
                  <td><a href="#" class="btn btn-cancel" title="Remove This Item"><i class="fa fa-remove"></i></a> <a class="product-image" href="#" title="product 1"><img style="width: 350px" src="{{asset('site/images/banan.jpg')}}" alt="Azrouel Dress" width="200"></a>
                    <h2 class="product-name"><a href="#" title="Azrouel Dress">ban an 6 nguoi</a></h2>
                    <div class="price-box">
                  ...
                  <td><a href="#" class="btn btn-cancel" title="Remove This Item"><i class="fa fa-remove"></i></a><a class="product-image" href="#" title="ban an 8 nguoi"><img style="width: 350px" src="{{asset('site/images/Banan8nguoi.jpg')}}" alt="Azrouel Dress" width="200"></a>
                    <h2 class="product-name"><a href="#" title="ban an 8 nguoi">ban an 8 nguoi</a></h2>
