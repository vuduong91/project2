...
@include('admin/master/danhmuc')
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="/admin/category/add_category"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Dashboard</a></li>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="col-md-8">
                            ...
                            <form role="form" method="post" action="/admin/category/xl_add" required>
								@csrf
								<div class="form-group">
									<label>Tên danh mục:</label>
									<input required type="text" name="nameCatr" class="form-control" placeholder="Tên danh mục...">
								</div>
